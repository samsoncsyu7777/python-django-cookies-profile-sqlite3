...
from messenger_backend.models import User, Profile
...
class Login(APIView):
    def post(self, request: Request):
        ...
        try:
            ...
            response = JsonResponse(user_dict, status=200)
            response.set_cookie('cookies', token, max_age=3600)
...
class Register(APIView):
    def post(self, request: Request):
        ...
        try:
            ...
            user_dict = user.to_dict()
            response = JsonResponse(user_dict, status=201)
            response.set_cookie('cookies', token, max_age=3600)
...
class LogOut(APIView):
    def delete(self, request: Request):
        ...
        response.set_cookie('cookies', '', max_age=0)
        return response
